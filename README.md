# Realtime Crime Detection and Prediction Analysis
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Abhay0149/realtime-crime-detection-prediction.git
   ```
2. Navigate to the project directory:

   ```bash
   cd realtime-crime-detection-prediction
   ```
